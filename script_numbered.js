    ...
    window.fetchMySubscription = async function () {
        ...
        try {
            ...
            if (userSnap.exists()) {
                ...
                let lastPaymentAmt = data.lastPaymentAmount ? `Γé╣${data.lastPaymentAmount}` : 'Not available';
