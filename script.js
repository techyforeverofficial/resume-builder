...
`;
                ...
                if (summaryText.trim() && summaryText !== '<br>') {
                    htmlStr += `
                            <div class="text" style="margin-bottom: 14px;">
                                ${summaryText}
                            </div>
                    `;
                }
                    ...
                    for (let i = 0; i < education.length; i++) {
                        ...
                        htmlStr += `
                                <div class="edu">
                                    ...
                                    <div class="edu-right">
                                        <strong>${window.formatEducationTitle(edu.degree, edu.fieldOfStudy)}</strong><br>
                                        ${escapeHTML(edu.school)}${edu.location ? `, ${escapeHTML(edu.location)}` : ''}
                                        ${edu.coursework && edu.coursework.trim() ? `<div class="text" style="margin-top:4px;"><strong>Coursework:</strong> ${escapeHTML(edu.coursework).replace(/\\n/g, '<br>')}</div>` : ''}
                                    </div>
                                </div>
                        `;
                    }
                ...
                if (projects.length > 0) {
                    ...
                    for (let i = 0; i < projects.length; i++) {
                        ...
                        htmlStr += `
                                <div class="job">
                                    <div class="job-left"></div>
                                    <div class="job-right">
                                        <div class="job-title">${escapeHTML(p.name)}</div>
                                        ${p.link ? `<div class="job-company"><a href="${escapeHTML(p.link)}" style="color:inherit;text-decoration:none;">${escapeHTML(p.link)}</a></div>` : ''}
                ...
                if (additionalInfo.languages && additionalInfo.languages.length > 0) {
                    htmlStr += `
                            <div class="section">
                                <div class="section-title">Languages</div>
                                <div class="skills">
                                    ${additionalInfo.languages.map(l => `<div class="skill">${escapeHTML(l.trim())}</div>`).join('')}
                                </div>
                            </div>
                    `;
                }
                ...
                if (data.phone) {
                    htmlStr += `
                                <div class="contact-item" style="display: inline-flex; align-items: center; gap: 6px;">
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" style="color: #6e8a8b; flex-shrink: 0;"><path d="M6.6 10.8a15.1 15.1 0 006.6 6.6l2.2-2.2c.3-.3.8-.4 1.2-.2 1.3.5 2.7.8 4.2.8.7 0 1.2.5 1.2 1.2V21c0 .7-.5 1.2-1.2 1.2C10.3 22.2 1.8 13.7 1.8 3.2 1.8 2.5 2.3 2 3 2h3.6c.7 0 1.2.5 1.2 1.2 0 1.5.3 2.9.8 4.2.1.4.1.9-.2 1.2l-2.2 2.2z"/></svg>
                                    ${escapeHTML(data.phone)}
                                </div>`;
                }
                if (data.email) {
                    htmlStr += `
                                <div class="contact-item" style="display: inline-flex; align-items: center; gap: 6px;">
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" style="color: #6e8a8b; flex-shrink: 0;"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>
                                    ${escapeHTML(data.email)}
                                </div>`;
                }
                ...
                if (loc18) {
                    htmlStr += `
                                <div class="contact-item" style="display: inline-flex; align-items: center; gap: 6px;">
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" style="color: #6e8a8b; flex-shrink: 0;"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>
                                    ${escapeHTML(loc18)}
                                </div>`;
                }
                const web18 = additionalInfo.website || additionalInfo.linkedin;
                if (web18) {
                    htmlStr += `
                                <div class="contact-item" style="display: inline-flex; align-items: center; gap: 6px;">
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" style="color: #6e8a8b; flex-shrink: 0;"><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zm6.93 6h-2.95c-.32-1.25-.78-2.45-1.38-3.56 1.84.63 3.37 1.91 4.33 3.56zM12 4.04c.83 1.2 1.48 2.53 1.91 3.96h-3.82c.43-1.43 1.08-2.76 1.91-3.96zM4.26 14C4.1 13.36 4 12.69 4 12s.1-1.36.26-2h3.38c-.08.66-.14 1.32-.14 2 0 .68.06 1.34.14 2H4.26zm.82 2h2.95c.32 1.25.78 2.45 1.38 3.56-1.84-.63-3.37-1.9-4.33-3.56zm2.95-8H5.08c.96-1.66 2.49-2.93 4.33-3.56C8.81 5.55 8.35 6.75 8.03 8zM12 19.96c-.83-1.2-1.48-2.53-1.91-3.96h3.82c-.43 1.43-1.08 2.76-1.91 3.96zM14.34 14H9.66c-.09-.66-.16-1.32-.16-2 0-.68.07-1.35.16-2h4.68c.09.65.16 1.32.16 2 0 .68-.07 1.34-.16 2zm.25 5.56c.6-1.11 1.06-2.31 1.38-3.56h2.95c-.96 1.65-2.49 2.93-4.33 3.56zM16.36 14c.08-.66.14-1.32.14-2 0-.68-.06-1.34-.14-2h3.38c.16.64.26 1.31.26 2s-.1 1.36-.26 2h-3.38z"/></svg>
                                    ${escapeHTML(web18)}
                                </div>`;
                }
                    ...
                    <div class="resume-wrapper">
                      ...
                      <div class="header">
                        <div class="header-logo">
                          <span>${escapeHTML(nameStr.charAt(0).toUpperCase())}</span>
                        </div>
                        <div class="header-name-area">
                          <div class="header-name">${escapeHTML(nameStr)}</div>
                        </div>
                      </div>
                      ...
                      <div class="contact-bar">
                        ...
                        ${[data.city, data.country].filter(Boolean).join(', ') ? `<div class="contact-item">${escapeHTML([data.city, data.country].filter(Boolean).join(', '))}</div>` : ''}
                        ${additionalInfo.website || additionalInfo.linkedin ? `<div class="contact-item">${escapeHTML(additionalInfo.website || additionalInfo.linkedin)}</div>` : ''}
                      </div>
                ...
                if (summaryText.trim() && summaryText !== '<br>') {
                    htmlStr += `
                          ...
                          <div class="section">
                            ...
                            <div class="section-body">${summaryText}</div>
                          </div>
                    `;
                }
                ...
                if (resumeData.experienceType !== 'fresher') {
                    if (workExpArray.length > 0) {
                        ...
                        for (let i = 0; i < workExpArray.length; i++) {
                            const exp = workExpArray[i];
                            if (!exp.company.trim()) continue;
                            const durationText = exp.current ? `Current - ${escapeHTML(exp.startYear)}` : `${escapeHTML(exp.endYear)} - ${escapeHTML(exp.startYear)}`;
                            htmlStr += `
                            <div class="job">
                              <div class="job-date">${durationText}</div>
                              <div class="job-title">${escapeHTML(exp.role)}${exp.company ? `, <span style="font-weight:400;">${escapeHTML(exp.company)}${exp.location ? `, ${escapeHTML(exp.location)}` : ''}</span>` : ''}</div>
                              ${exp.description ? `<div style="margin-top:4px;">${exp.description}</div>` : ''}
                            </div>
                            `;
                        }
                        htmlStr += `</div>`;
...
<div class="page">
  ...
  <div class="body">
    ...
    <div class="section">
      ...
      <div class="section-divider"></div>
      <div class="skills-grid">
        ${skillsList.map(s => `<div class="skill-item">${escapeHTML(s.trim())}</div>`).join('')}
      </div>
    </div>`;
                }
    ...
    <div class="section">
      ...
      <div class="section-divider"></div>
                        ...
                        for (let i = 0; i < workExpArray.length; i++) {
                            const exp = workExpArray[i];
                            if (!exp.company.trim()) continue;
                            const durationText = exp.current ? `${escapeHTML(exp.startYear)} to Current` : `${escapeHTML(exp.startYear)} to ${escapeHTML(exp.endYear)}`;
                            htmlStr += `
      <div class="job">
        <div class="job-meta">${escapeHTML(exp.role)}, ${durationText}</div>
        <div class="job-company"><strong>${escapeHTML(exp.company)}</strong>${exp.location ? ` &ndash; ${escapeHTML(exp.location)}` : ''}</div>
        ${exp.description ? `<div class="job-bullets">${exp.description}</div>` : ''}
      </div>`;
                        }
                        htmlStr += `</div>`;
                    }
    ...
    <div class="section">
      ...
      <div class="section-divider"></div>
                    ...
                    for (let i = 0; i < projects.length; i++) {
                        ...
                        htmlStr += `
      <div class="job">
        <div class="job-meta">${escapeHTML(p.name)}</div>
        ${p.link ? `<div style="font-size:12px;margin-bottom:3px;"><a href="${escapeHTML(p.link)}" style="color:inherit;text-decoration:none;">${escapeHTML(p.link)}</a></div>` : ''}
        ${p.desc ? `<div class="job-bullets">${p.desc}</div>` : ''}
      </div>`;
                    }
                    htmlStr += `</div>`;
                }
    ...
    <div class="section">
      ...
      <div class="section-divider"></div>
                    ...
                    for (let i = 0; i < education.length; i++) {
                        ...
                        htmlStr += `
      <div style="margin-bottom: 12px;">
        <div class="edu-degree">${window.formatEducationTitle(edu.degree, edu.fieldOfStudy)}${durationStr ? `, ${durationStr}` : ''}</div>
        <div class="edu-school"><strong>${escapeHTML(edu.school)}</strong>${edu.location ? ` &ndash; ${escapeHTML(edu.location)}` : ''}</div>
        ${edu.coursework && edu.coursework.trim() ? `<div style="font-size:12px;margin-top:2px;"><strong>Coursework:</strong> ${escapeHTML(edu.coursework).replace(/\\n/g, '<br>')}</div>` : ''}
      </div>`;
                    }
                    htmlStr += `</div>`;
    ...
    <div class="section">
      <div class="section-title">Certifications</div>
      <div class="section-divider"></div>
      <div class="summary-text">${additionalInfo.certifications}</div>
    </div>`;
                }
    ...
    <div class="section">
      ...
      <div class="section-divider"></div>
      <div class="skills-grid">
        ${additionalInfo.languages.map(l => `<div class="skill-item">${escapeHTML(l.trim())}</div>`).join('')}
      </div>
    </div>`;
                }
    ...
    <div class="section">
      <div class="section-title">Hobbies</div>
      <div class="section-divider"></div>
      <div class="summary-text">${additionalInfo.hobbies}</div>
    </div>`;
                }
    ...
    <div class="section">
      <div class="section-title">Personal Details</div>
      <div class="section-divider"></div>
      <div class="summary-text" style="display:flex;flex-direction:column;gap:4px;">
                    `;
                    if (additionalInfo.nationality) htmlStr += `<div><strong>Nationality:</strong> ${escapeHTML(additionalInfo.nationality)}</div>`;
                    if (additionalInfo.maritalStatus) htmlStr += `<div><strong>Marital Status:</strong> ${escapeHTML(additionalInfo.maritalStatus)}</div>`;
                    if (additionalInfo.visaStatus) htmlStr += `<div><strong>Visa Status:</strong> ${escapeHTML(additionalInfo.visaStatus)}</div>`;
  ...
  <div class="left">
    ...
    <div class="profile-img" style="background-image: url('${data.photo || 'https://via.placeholder.com/150'}');"></div>
    ...
    <div class="section">
      <h3>Education</h3>
                    ...
                    for (let i = 0; i < education.length; i++) {
                        ...
                        let durationStr = `${escapeHTML(edu.gradMonth || '')} ${escapeHTML(edu.gradYear || '')}`.trim();
                        htmlStr += `
      <p><strong>${window.formatEducationTitle(edu.degree, edu.fieldOfStudy)}</strong><br>${escapeHTML(edu.school)}<br>${durationStr}</p>
                        `;
                    }
                    htmlStr += `</div>`;
                }
    ...
    <div class="section">
      <h3>Personal Details</h3>
      ${additionalInfo.nationality ? `<p><strong>Nationality:</strong> ${escapeHTML(additionalInfo.nationality)}</p>` : ''}
      ${additionalInfo.maritalStatus ? `<p><strong>Marital Status:</strong> ${escapeHTML(additionalInfo.maritalStatus)}</p>` : ''}
      ${additionalInfo.visaStatus ? `<p><strong>Visa Status:</strong> ${escapeHTML(additionalInfo.visaStatus)}</p>` : ''}
      ${additionalInfo.dob ? `<p><strong>DOB:</strong> ${escapeHTML(additionalInfo.dob)}</p>` : ''}
    </div>
                    `;
                }
  ...
  <div class="right">
    ...
    <div class="title">${escapeHTML(data.title || '')}</div>
                ...
                if (resumeData.summary || data.summary) {
                    htmlStr += `
    <div class="right-section">
      <h3>About Me</h3>
    ...
    <div class="right-section">
      <h3>Work Experience</h3>
                        ...
                        for (let i = 0; i < workExpArray.length; i++) {
                            const exp = workExpArray[i];
                            if (!exp.company.trim()) continue;
                            let durationStr = `${escapeHTML(exp.startMonth || '')} ${escapeHTML(exp.startYear || '')} – ${exp.current ? 'Present' : escapeHTML(exp.endMonth || '') + ' ' + escapeHTML(exp.endYear || '')}`.trim();
                            htmlStr += `
      <div class="job">
        <div class="job-title">${durationStr}</div>
        <div class="job-company">${escapeHTML(exp.company)}<br>${escapeHTML(exp.role)}</div>
        <div class="job-bullets">${exp.description || ''}</div>
      </div>
                            `;
                        }
                        htmlStr += `</div>`;
    ...
    <div class="right-section">
      <h3>Certifications</h3>
      <div class="job-bullets">${additionalInfo.certifications}</div>
    </div>
                    `;
                }
    ...
    <div class="right-section">
      <h3>Hobbies</h3>
      <div class="job-bullets">${additionalInfo.hobbies}</div>
    </div>
                    `;
                }
